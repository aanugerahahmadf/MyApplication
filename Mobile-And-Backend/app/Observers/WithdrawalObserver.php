    ...
    public function created(Withdrawal $withdrawal): void
    {
        ...
        if ($isRefundStatus) {
            ...
            if ($user) {
                ...
                [$withdrawTitle, $withdrawBody] = PlatformNotificationService::withRecipientLocale(
                    $user,
                    fn () => [
                        __('Penarikan Saldo Ditolak'),
                        __('Saldo sebesar Rp :amount telah dikembalikan ke akun Anda.', [
                ...
                PlatformNotificationService::send($user, $withdrawTitle, $withdrawBody);
            }
        }
    }
